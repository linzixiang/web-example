package com.linzx.integrate.thirdpay.utils.sign;


import com.linzx.integrate.thirdpay.exception.PayErrorException;
import com.linzx.integrate.thirdpay.exception.PayException;
...
public enum SignUtils {
    ...
    MD5 {
        ...
        public String createSign(String content, String key, String characterEncoding) {
            ...
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.MD5.sign(content, key, characterEncoding);
        }
        ...
        public boolean verify(String text, String sign, String key, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.MD5.verify(text, sign, key, characterEncoding);
        }
    },HMACSHA256{
        /**
         * 签名
    ...
    RSA {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.RSA.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.RSA.verify(text, sign, publicKey, characterEncoding);
        }
    },
    ...
    RSA2 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.RSA2.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.RSA2.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA1 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.SHA1.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.SHA1.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA256 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.SHA256.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.linzx.integrate.thirdpay.utils.sign.encrypt.SHA256.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SM3 {
        @Override
