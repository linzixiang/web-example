...
import com.linzx.integrate.thirdpay.http.HttpRequestTemplate;
import com.linzx.integrate.thirdpay.utils.sign.SignUtils;
import com.linzx.utils.MatrixToImageUtils;
...
public abstract class BasePayService<PC extends PayConfigStorage> implements PayService<PC> {
    ...
    protected String authorizationString(String user, String password) {
        ...
        try {
            base64ClientID = com.linzx.integrate.thirdpay.utils.sign.encrypt.Base64.encode(String.format("%s:%s", user, password).getBytes("UTF-8"));
    ...
    public BufferedImage genQrPay(PayOrder order) {
       return MatrixToImageUtils.writeInfoToJpgBuff(getQrPay(order));
    }
