package com.linzx.generator.service.impl;
...
import com.linzx.generator.mapper.GenMapper;
import com.linzx.generator.service.IGenService;
import com.linzx.generator.util.GenUtils;
import com.linzx.generator.util.VelocityInitializer;
...
public class GenServiceImpl implements IGenService {
    ...
    public void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip) {
        ...
        for (String template : templates) {
            ...
            Template tpl = Velocity.getTemplate(template, Constants.CHARSET_UTF8);
            tpl.merge(context, sw);
            try {
                // 添加到zip
                zip.putNextEntry(new ZipEntry(GenUtils.getFileName(template, table, moduleName)));
                IOUtils.write(sw.toString(), zip, Constants.CHARSET_UTF8);
