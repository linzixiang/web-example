package com.linzx.utils.murmurhash;
...
public class MurmurHashTest {
    ...
    public void testHash32ByteArrayIntInt() {
        for (int i=0; i<input.length; i++) {
            int hash = MurmurHashUtils.hash32( input[i], input[i].length, 0x71b4954d);
    ...
    public void testHash32ByteArrayInt() {
        for (int i=0; i<input.length; i++) {
            int hash = MurmurHashUtils.hash32( input[i], input[i].length);
    ...
    public void testHash32String() {
        int hash = MurmurHashUtils.hash32( text);
    ...
    public void testHash32StringIntInt() {
        int hash = MurmurHashUtils.hash32( text, 2, text.length()-4);
    ...
    public void testHash64ByteArrayIntInt() {
        for (int i=0; i<input.length; i++) {
            long hash = MurmurHashUtils.hash64( input[i], input[i].length, 0x344d1f5c);
    ...
    public void testHash64ByteArrayInt() {
        for (int i=0; i<input.length; i++) {
            long hash = MurmurHashUtils.hash64( input[i], input[i].length);
    ...
    public void testHash64String() {
        long hash = MurmurHashUtils.hash64( text);
    ...
    public void testHash64StringIntInt() {
        long hash = MurmurHashUtils.hash64( text, 2, text.length()-4);
