...
public class DemoTableController {
    ...
    public AjaxResult list() {
        ...
        Page<UserTableModel> page = new Page<>();
        page.addAll(userList.subList(pageNum, pageSize));
        page.setTotal(userList.size());
        Double userBalance = new Double(1500);
        Map<String, Double> rowMap = new HashMap<>();
        rowMap.put("userBalance", userBalance);
        page.setNeedSum(true);
        page.setRowSum(rowMap);
