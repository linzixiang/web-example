...
public class ShiroSessionValidationScheduler implements SessionValidationScheduler {
    ...
    private static final Logger log = LoggerFactory.getLogger(ShiroSessionValidationScheduler.class);
     ...
     * Default constructor.
     */
    public ShiroSessionValidationScheduler() {
    }
     ...
     */
    public ShiroSessionValidationScheduler(ValidatingSessionManager sessionManager) {
